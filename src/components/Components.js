...
export const Overlay = styled.div`
  ...
  background: -webkit-linear-gradient(to right, rgba(255, 75, 43, 0.85), rgba(255, 65, 108, 0.85));
  background: linear-gradient(to right, rgba(255, 75, 43, 0.85), rgba(255, 65, 108, 0.85));
